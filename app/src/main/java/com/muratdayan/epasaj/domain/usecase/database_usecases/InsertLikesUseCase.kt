...
class InsertLikesUseCase @Inject constructor(
    private val databaseRepository: DatabaseRepository
){
    suspend operator fun invoke(userLikesModel: UserLikesModel) = databaseRepository.insertUserLikes(userLikesModel)
